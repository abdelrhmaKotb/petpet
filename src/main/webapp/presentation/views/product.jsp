            ...
            <div class="page-content">
                <div class="container">
                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            <img id="product-zoom"
                                                src="/petpet${requestScope.product.getImagesUlrs().get(0)}"
                                                data-zoom-image="/petpet${requestScope.product.getImagesUlrs().get(0)}"
                                                alt="product image">
                                        ...
                                        <div id="product-zoom-gallery" class="product-image-gallery">
                                            <c:forEach var="imageUrl" begin="1"
                                                items="${requestScope.product.getImagesUlrs()}">
                                                <a class="product-gallery-item" href="#" data-image="/petpet${imageUrl}"
                                                    data-zoom-image="/petpet${imageUrl}">
                                                    <img src="/petpet${imageUrl}" alt="product back">
                                                </a>
                                            </c:forEach>
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    ...
                                    <div class="product-content">
                                        <p> ${fn:substring(requestScope.product.getDescription(),0,25)}......</p>
                                    ...
                                    <div class="details-filter-row details-row-size">
                                        ...
                                        <div class="product-details-quantity">
                                            <input type="number" id="qty" class="form-control" value="1" min="1"
                                                max="${requestScope.product.getQuantity()}" step="1" data-decimals="0"
                                                required>
                                        </div><!-- End .product-details-quantity -->
                                    </div><!-- End .details-filter-row -->
                                    <!--add to cart -->
                                    <div class="product-details-action">
                                        <a href="javascript:void(0)" data-image="${requestScope.product.getImagesUlrs().get(0)}"
                                            data-id="${requestScope.product.getId()}" data-price="${requestScope.product.getPrice()}"
                                            data-name="${requestScope.product.getName()}"
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        ...
                        <!-- Recommendation Products if we will put it  --->
