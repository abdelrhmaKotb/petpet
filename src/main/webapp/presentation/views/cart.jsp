		...
		<div class="page-content">
			<div class="cart">
				<div class="container">
					<div class="row">
						<div class="col-lg-9">
							<table class="table table-cart table-mobile" id="products-cart">
								<thead>
									<tr>
										<th>Product</th>
										<th>Price</th>
								...
								<tbody>
									...
									<c:forEach var="item" items="${cart}">
										...
										<tr data-id="${item.getProductId()}">
											...
											<td class="price-col">${item.getProductPrice()}</td>
											<td class="quantity-col">
												<div class="cart-product-quantity">
													<input type="number" class="form-control"
														value="${item.getProductQty()}" min="1" max="10" step="1"
														data-decimals="0" required>
												</div><!-- End .cart-product-quantity -->
											</td>
											<td class="total-col">${item.getProductPrice() * item.getProductQty()}</td>
											<td class="remove-col"><button class="btn-remove"
													data-id="${item.getProductId()}"><i class="icon-close"></i></button>
											</td>
										</tr>
							...
							<div class="cart-bottom">
								...
								<button class="btn btn-outline-dark-2" id="updatecart"><span>UPDATE CART</span><i
