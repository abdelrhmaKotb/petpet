                    ...
                    <ul class="top-menu">
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="/petpet/wishlist"><i class="icon-heart-o"></i>Wishlist <span>(3)</span></a></li>
                                <li><a href="/petpet/about">About Us</a></li>
                                <li><a href="/petpet/contact">Contact Us</a></li>
                                <li><a href="/petpet/login" data-toggle="modal"><i class="icon-user"></i>Login</a></li>
                            </ul>
                        </li>
                    </ul><!-- End .top-menu -->
            ...
            <div class="container">
                <div class="header-left">
                    ...
                    <a href="/petpet/home" class="logo">
                        <img src="/petpet/presentation/assets/images/logo.png" alt="PetPet Logo" width="105" height="25">
                    </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-cart-products">
                                <div class="product">
                                    ...
                                    <figure class="product-image-container">
                                        <a href="product.html" class="product-image">
                                            <img src="/petpet/presentation/assets/images/products/cart/product-1.jpg" alt="product">
                                        </a>
                                    </figure>
                                ...
                                <div class="product">
                                    ...
                                    <figure class="product-image-container">
                                        <a href="product.html" class="product-image">
                                            <img src="/petpet/presentation/assets/images/products/cart/product-2.jpg" alt="product">
                                        </a>
                                    </figure>
                                    <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                </div><!-- End .product -->
