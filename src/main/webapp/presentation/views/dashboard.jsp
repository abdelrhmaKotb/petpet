                                    ...
                                    <c:otherwise>
                                        <c:choose>
                                            <c:when test="${requestScope.totalOrders < 1}">
                                                <p>No order has been made yet </span><a href="/petpet/Shop">go shopping
                                                    ?</a>.</p>
                                            </c:when>
                                            <c:otherwise>
                                                <c:choose>
                                                ...
                                                <table id="" class="table">
                                                    ...
                                                    <c:forEach var="item" items="${requestScope.orders}">
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td class="action-col">
                                                                <button class="btn btn-block btn-outline-primary-2"><a
                            ...
                            <div class="tab-pane fade" id="tab-account" role="tabpanel"
                                ...
                                <form action="#">
                                    ...
                                    <div id="name-div" class="col-sm-12">
                                        <label for="update-Name">Display Name *</label>
                                        <input type="text" class="form-control" id="update-Name"
                                               value="${sessionScope.userSession.getName()}"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group form-outline">
                                            <input type="email" class="form-control" id="update-username"
                                                   value="${sessionScope.userSession.getEmail()}"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="tel" class="form-control" id="upd-phon" name="upd-phon"
                                               value="${sessionScope.userSession.getPhone()}"
