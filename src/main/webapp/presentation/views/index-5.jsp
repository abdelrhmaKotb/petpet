...
<html lang="en">
    ...
    <body>
        <div class="page-wrapper">
            ...
            <footer class="footer footer-2">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-lg-6">
                                <div class="widget widget-about">
                                    <img
                                        src="/petpet/presentation/assets/images/demos/demo-5/logo-footer.png"
                                        class="footer-logo" alt="Footer Logo"
                                        width="105" height="25">
                                    <p>Praesent dapibus, neque id cursus ucibus,
                                    ...
                                    <div class="widget-about-info">
                                        <div class="row">
                                            <div class="col-sm-6 col-md-4">
                                                <span
                                                    class="widget-about-title">Got
                                                    Question? Call us 24/7</span>
                                                <a href="tel:123456789">+0123
                                                    456 789</a>
                                            </div><!-- End .col-sm-6 -->
                                            <div class="col-sm-6 col-md-8">
                                                <span
                                                    class="widget-about-title">Payment
                                                    Method</span>
                ...
                <div class="footer-bottom">
                    <div class="container">
                        <p class="footer-copyright">Copyright © 2019 Molla
                            Store. All Rights Reserved.</p><!-- End .footer-copyright -->
            ...
            <div class="mobile-menu-wrapper">
                ...
                <form action="#" method="get" class="mobile-search">
                    ...
                    <input type="search" class="form-control"
                        name="mobile-search" id="mobile-search"
                            ...
                            <div class="banner-content text-center">
                                ...
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label"
                                        for="register-policy-2">Do not show this
                                        popup again</label>
        ...
        <script
            src="/petpet/presentation/assets/js/jquery.magnific-popup.min.js"></script>
    ...
    <!-- molla/index-5.jsp  22 Nov 2019 09:56:18 GMT -->
</html>