<%@taglib prefix="c" uri="jakarta.tags.core" %>
    ...
    <head>
        ...
        <link rel="icon" type="image/png" sizes="16x16"
            href="/petpet/presentation/assets/images/icons/favicon-32x32.png">
        <link rel="manifest" href="/petpet/presentation/assets/images/icons/site.jsp">
        ...
        <link rel="stylesheet" href="/petpet/presentation/assets/css/plugins/owl-carousel/owl.carousel.css">
        <link rel="stylesheet" href="/petpet/presentation/assets/css/plugins/magnific-popup/magnific-popup.css">
        <link rel="stylesheet" href="/petpet/presentation/assets/css/plugins/jquery.countdown.css">
        <!-- Main CSS File -->
        <!-- content Style -->
                    ...
                    <div class="container-fluid">
                        <div class="header-left">
                            ...
                            <a href="/petpet/home" class="logo">
                                <img src="/petpet/presentation/assets/images/demos/demo-5/logo.png" alt="Molla Logo"
                                    width="105" height="25">
                            </a>
                            ...
                            <nav class="main-nav">
                                <ul class="menu sf-arrows">
                                    ...
                                    <li>
                                        <a href="/petpet/contact">Contact</a>
                                    </li>
                                    <c:choose>
                            ...
                            <c:if test="${not empty sessionScope.userSession}">
                                ...
                                <div class="nav-line-1-container">
                                    <span id="nav-link-accountList-nav-line-1"
                                        style=" font-family: Poppins ; color: whitesmoke; font-weight: bold; position: center "
            ...
            <main class="main">
                <div class="intro-slider-container mb-0">
                    <div class="intro-slider owl-carousel owl-theme
                        owl-nav-inside owl-light" data-toggle="owl" data-owl-options='{" nav": false, "dots": false}'>
                        <div class="intro-slide" style="background-image:
                            ...
                            <div class="container intro-content text-center">
                                <h3 class="intro-subtitle text-white">Discover over collections</h3>
                                <br><!-- End .h3 intro-subtitle -->
                                ...
                                <a href="/petpet/Shop" class="btn btn-primary">Discover NOW</a>
                        ...
                        <div class="intro-slide" style="background-image:
                            ...
                            <div class="container intro-content text-center">
                                ...
                                <a href="/petpet/Shop" class="btn btn-primary">Shop NOW</a>
                            </div><!-- End .intro-content -->
                        </div><!-- End .intro-slide -->
                ...
                <div class="brands-border owl-carousel owl-simple mb-5" data-toggle="owl" data-owl-options='{
                    "nav": false,
                    "dots": false,
                    "margin": 0,
                    "loop": false,
                    ...
                    <a href="#" class="brand">
                        <img src="/petpet/presentation/assets/images/brands/1.png" alt="Brand Name">
                    </a>

                    <a href="#" class="brand">
                        <img src="/petpet/presentation/assets/images/brands/2.png" alt="Brand Name">
                    </a>
                    ...
                    <a href="#" class="brand">
                        <img src="/petpet/presentation/assets/images/brands/4.png" alt="Brand Name">
                    </a>

                    <a href="#" class="brand">
                        <img src="/petpet/presentation/assets/images/brands/5.png" alt="Brand Name">
                    </a>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="banner banner-border-hover">
                                    ...
                                    <div class="banner-content">
                                        ...
                                        <h3 class="banner-title"><a href="/petpet/Shop"><span>Accessories</span></a>
                                        </h3><!-- End .banner-title -->
                                        <a href="/petpet/Shop" class="btn
                                            btn-outline-primary-2 banner-link">Discover
                                            Now<i class="icon-long-arrow-right"></i></a>
                ...
                <div class="container">
                    <div class="heading heading-center mb-3">
                        ...
                        <ul class="nav nav-pills justify-content-center" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link allCategories active" id="trendy-all-link" data-toggle="tab"
                                    href="#trendy-all-tab" role="tab" aria-controls="trendy-all-tab"
                                    aria-selected="true">All</a>
                            </li>
                            <c:forEach var="category" items="${requestScope.mainCategories}">
                                <li class="nav-item">
                                    <a class="nav-link ${category.getId()} " id="trendy-all-link" data-toggle="tab"
                                        href="#cat-${category.getId()}" role="tab" aria-controls="${category.getId()}"
                    ...
                    <div class="tab-content tab-content-carousel">
                        <div class="tab-pane p-0 fade show active" id="trendy-all-tab" role="tabpanel"
                            ...
                            <div class="owl-carousel owl-simple
                                carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                                "nav": false,
                                "dots": true,
                                "margin": 20,
                                "loop": false,
                                ...
                                <c:forEach var="trendy" items="${requestScope.trendyProductsDTOS}">
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            <a href="/petpet/product?id=${trendy.getProduct().getId()}">
                                                <img src="/petpet${trendy.getProduct().getImages().get(0).getImageUrl()}"
                                                    alt="Product image" class="product-image">
                                                <c:if test="${trendy.getProduct().getImages().size() > 1 }">
                                                    <img src="/petpet${trendy.getProduct().getImages().get(1).getImageUrl()}"
                                            ...
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon
                                                   btn-wishlist btn-expandable" title="Add to wishlist"><span>add
                                                        to wishlist</span></a>
                                            </div><!-- End .product-action -->

                                            <div class="product-action
                                               product-action-transparent">
                                                <a href="javascript:void(0)" data-id="${trendy.getProduct().getId()}"
                                                    data-price="${trendy.getProduct().getPrice()}"
                                                    data-name="${trendy.getProduct().getName()}"
                                                    class="btn-product btn-cart addToCart"><span>add to cart</span></a>
                                            </div><!-- End .product-action -->
                        ...
                        <c:forEach var="category" items="${requestScope.mainCategories}">
                            <div class="tab-pane p-0 fade" id="cat-${category.getId()}" role="tabpanel"
                                aria-labelledby="${category.getId()}">
                                <div class="owl-carousel owl-simple
                                carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                                "nav": false,
                                "dots": true,
                                            ...
                                            <div class="product product-2">
                                                <figure class="product-media">
                                                   ...
                                                   btn-wishlist btn-expandable" title="Add to wishlist"><span>add
                                                    ...
                                                    <div class="product-action
                                               product-action-transparent">
                                                        <a href="javascript:void(0)" data-id="${products.getId()}"
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <h3 class="product-title"><a
                                                            ...
                                                            ${trendy.getProduct().getName()}</a></h3>
                                                    <!-- End .product-title -->
                                                    <div class="product-price">
                                                        ${trendy.getProduct().getPrice()}
                                                    </div><!-- End .product-price -->
                ...
                <div class="video-banner video-banner-bg bg-image text-center" style="background-image:
                                ...
                                <div class="cta-wrapper cta-text text-center">
                                    ...
                                    <div class="social-icons
                                        ...
                                        <a href="#" class="social-icon
                                            social-facebook" title="Facebook" target="_blank"><i
                                                class="icon-facebook-f"></i></a>
                                        <a href="#" class="social-icon
                                            social-twitter" title="Twitter" target="_blank"><i
                                                class="icon-twitter"></i></a>
                                        <a href="#" class="social-icon
                                            social-instagram" title="Instagram" target="_blank"><i
                                                class="icon-instagram"></i></a>
                                        <a href="#" class="social-icon
                                            social-youtube" title="Youtube" target="_blank"><i
                                                class="icon-youtube"></i></a>
                                        <a href="#" class="social-icon
                                            social-pinterest" title="Pinterest" target="_blank"><i
                            ...
                            <div class="row">
                                <div class="feed-col">
                                    <div class="instagram-feed">
                                        <img src="/petpet/presentation/assets/images/demos/demo-5/instagram/11.jpg"
                                            alt="img">
                                ...
                                <div class="feed-col">
                                    <div class="instagram-feed">
                                        <img src="/petpet/presentation/assets/images/demos/demo-5/instagram/12.jpg"
                                            style="height: 100%" alt="img">
                                ...
                                <div class="feed-col">
                                    <div class="instagram-feed">
                                        <img src="/petpet/presentation/assets/images/demos/demo-5/instagram/13.jpg"
                                            alt="img">
                                ...
                                <div class="feed-col">
                                    <div class="instagram-feed">
                                        <img src="/petpet/presentation/assets/images/demos/demo-5/instagram/14.jpg"
                                            alt="img">
                                ...
                                <div class="feed-col">
                                    <div class="instagram-feed">
                                        <img src="/petpet/presentation/assets/images/demos/demo-5/instagram/15.jpg"
                                            alt="img">
                                ...
                                <div class="feed-col">
                                    <div class="instagram-feed">
                                        <img src="/petpet/presentation/assets/images/demos/demo-5/instagram/16.jpg"
                                            alt="img">
                                ...
                                <div class="feed-col">
                                    <div class="instagram-feed">
                                        <img src="/petpet/presentation/assets/images/demos/demo-5/instagram/17.jpg"
                                            alt="img">
                                ...
                                <div class="feed-col">
                                    <div class="instagram-feed">
                                        <img src="/petpet/presentation/assets/images/demos/demo-5/instagram/18.jpg"
                                            alt="img">
                                ...
                                <div class="feed-col">
                                    <div class="instagram-feed">
                                        <img src="/petpet/presentation/assets/images/demos/demo-5/instagram/19.jpg"
                                            alt="img">
